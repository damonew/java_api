...
-- Power Plant table
CREATE TABLE IF NOT EXISTS grid_user.power_plants (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
-- Substation table
CREATE TABLE IF NOT EXISTS grid_user.substations (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
    location VARCHAR(255),
    grid_operator_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS grid_user.transmission_lines (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS grid_user.market_participants (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS grid_user.market_transactions (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
-- Meter table
CREATE TABLE IF NOT EXISTS grid_user.meters (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    participant_id BIGINT NOT NULL,
    timestamp TIMESTAMP NOT NULL,
    epoch BIGINT NOT NULL,
...
-- Forecast table
CREATE TABLE IF NOT EXISTS grid_user.forecasts (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    grid_operator_id BIGINT NOT NULL,
    timestamp TIMESTAMP NOT NULL,
    epoch BIGINT NOT NULL,
